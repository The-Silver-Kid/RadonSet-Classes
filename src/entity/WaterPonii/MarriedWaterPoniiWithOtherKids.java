...
public class MarriedWaterPoniiWithOtherKids extends WaterPonii {

	public MarriedWaterPoniiWithOtherKids(String Name, String AlternateName, String Flag, Boolean Gender, Boolean IsVamponii, String Description, String CutiiMarkInfo, String ManeColour, String TailColour, String Mother, String Father, Day bday, String Imagename, String CutiimarkImage, String Marriedto, String[] kidNames, String[] kidOtherParent) {
		this.name = Name;
		this.Gender = Gender;
